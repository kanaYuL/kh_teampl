...
<body>
	<div id="loginDivWrapper">
		<div id="loginDiv">
			<div id="resultDiv" class="alert alert-warning" role="alert"
				style="display: none;">
			</div>
			
			<form action="/user/findPwdRun" method="post">
			...
			<button class="btn btn-primary w-100 py-2" type="submit">비밀번호 찾기</button>
